...
def exp_config():
    ...
    if scenario == "mhd":
        ...
        scenario_config = sacred_scenario.ice()
        down_train_config = sacred_down.ice()
        dca_evaluation_config = sacred_dca.ice()
        model_config = sacred_model.gmc_ice()
        model_train_config = sacred_model.gmc_ice_train()
        evaluation_mods = [0, 1]
